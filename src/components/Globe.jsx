...
const CustomThreeGlobe = (props) => {
  return <threeGlobe {...props} />;
};
...
const Globe = ({ globeConfig, data }) => {
  ...
  return <CustomThreeGlobe ref={globeRef} />;
};
...
export default { Globe, WebGLRendererConfig, World, hexToRgb, genRandomNumbers };